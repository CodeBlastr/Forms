...
echo $this->Form->hidden('Form.success_message', array('value' => 'Answers saved.'));
echo $this->Form->hidden('Form.success_url', array('value' => 'dynamic'));
echo $this->Form->hidden('Form.fail_message', array('value' => 'Unable to save answers.  Try again.'));
echo $this->Form->hidden('Form.fail_url', array('value' => 'dynamic'));
